...
public class Jack {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    File arquivo = new File("config3.txt");
    ...
    mensagens.add("2222;maquinanaoexiste:Jack:Bob:0:Oi Bob!");
    mensagens.add("2222;maquinanaoexiste:Jack:Rose:0:Oi Rose!");
    mensagens.add("2222;maquinanaoexiste:Jack:TODOS:0:Oi todos!");
